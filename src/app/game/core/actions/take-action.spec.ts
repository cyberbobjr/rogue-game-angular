...
describe('take-action', () => {
    ...
    it('should be created', () => {
        const takeAction: TakeAction = new TakeAction(null, gameEngine);
        expect(takeAction)
            .toBeTruthy();
    });
    ...
    it('should take objects from tile', () => {
        ...
        const freePosition: Position2D = gameMap.getFreePositionForRoom(0);

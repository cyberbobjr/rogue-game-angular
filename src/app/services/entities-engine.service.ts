...
import {GameEngineService} from './game-engine-imp.service';
...
export class EntitiesEngine {
  ...
  executeEntitiesActions(gameEngine: GameEngineService) {
  ...
  getEntitiesVisiblesOnMap(gameMap: GameMapImp) {
    return this._gameEntities.getEntitiesVisiblesOnMap(gameMap);
  }

  setVisibilityForEntities(gameMap: GameMapImp) {

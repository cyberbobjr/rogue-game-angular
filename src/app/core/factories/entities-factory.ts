...
import * as gamemonster from '../data/race/monster.json';
...
export class EntitiesFactory {
    ...
    constructor() {
        ...
        for (const key of Object.keys(gamemonster)) {
            this._monstersClass.set(gamemonster[key].id, new GameMonsterClass(gamemonster[key]));
        }
        this.setMaxPop(1);
    }
